public class Player
{
    ...
    public List<double> BAB { get; set; } = new List<double>();
    ...
    public void AssignClass(CharacterClass _Class)
    {
        this.Class = _Class;
        this.HP += _Class.HPDieRoll;
        this.BAB.Add(this.Class.BaseAttackBonus);
    }
    ...
    public void EquipShield(Armor _Shield)
    {
        if (this.Shield != null)
        {
            this.ArmorClass -= this.Shield.ArmorClass;
    ...
    public void LevelUp()
    {
        ...
        foreach (double BAB in this.BAB)
        {
            NumberOfAttacks.Add(BAB + this.Class.BaseAttackBonus);
        }
        ...
        {
            NumberOfAttacks.Add(this.Class.BaseAttackBonus);
        }
        this.BAB = new List<double>();
    ...
    public void Attack(Player Enemy)
    {
        ...
        if (this.Class.DoubleAttack)
        {
            ...
            AttackRoll += (int)Math.Floor(this.BAB[0]) + (int)((this.Dexterity - 10) / 2);
        ...
        for (int i = 0; i < Attacks.Count(); i++)
        {
            ...
            {
                int Damage = d(this.Weapon.Damage);
                if (Crits[i] == true)
                {
                    Damage = Damage * 2;
